...
export default function ProductList({ 
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Filters */}
      {showFilters && (
        <div className="sticky top-[var(--mobile-app-header-height)] z-40 mb-6 border-b border-gray-200 bg-gray-50 px-2 py-1.5 shadow-sm md:top-[var(--listing-filter-sticky-top)] md:border-t-0 md:shadow-none">
