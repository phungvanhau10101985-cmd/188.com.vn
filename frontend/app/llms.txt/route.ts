...
## URL chính
- [Trang chủ](${origin}/): danh sách sản phẩm và danh mục gợi ý
- [Danh mục](${origin}/danh-muc): cây danh mục thời trang
- [Ladipage](${origin}/lp/{slug}): landing bộ sưu tập / long-tail
...
- [Sitemap chính](${origin}/sitemap.xml): sản phẩm, ladipage multi, trang tĩnh
...
## Feed catalog (TSV)
- [Google Merchant](${origin}/api/v1/import-export/export/merchant-center-feed.tsv)
- [Meta catalog](${origin}/api/v1/import-export/export/meta-catalog-feed.tsv)
- [TikTok catalog](${origin}/api/v1/import-export/export/tiktok-catalog-feed.tsv)
...
## Liên hệ
[${origin}/info/lien-he](${origin}/info/lien-he)
`;
}
