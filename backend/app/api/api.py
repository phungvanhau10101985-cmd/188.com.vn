...
from app.api.endpoints import (
    ...
    promotions,
    sale_calendar, marketing_banners, marketing_icons, newsletter, google_merchant,
    email_preferences,
...
api_router.include_router(marketing_icons.router, prefix="/marketing-icons", tags=["marketing-icons"])
...
api_router.include_router(shipping_lookup.router, prefix="/shipping", tags=["shipping-lookup"]) 
