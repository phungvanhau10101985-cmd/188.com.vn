...
IMAGE_CLASSIFICATION = {
    ...
    'URGENT_DELETE_KEYWORDS': [
        ...
        # 9b. Giảm giá / banner promo Taobao-Tmall (xóa ảnh marketing)
        '更优惠', '立减', '满减', '折扣', '促销', '特价', '秒杀',
        '抢先购', '淘金币', '消费券', '优惠券', '叠加优惠', '叠加消费券',
...
URGENT_DELETE_PATTERNS = [
    ...
    # 5b. Giảm giá / banner promo (xóa ảnh)
    r'更优惠',
    r'立减',
    r'满减',
    r'折扣',
