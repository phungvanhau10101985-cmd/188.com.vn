...
upsert DATABASE_POOL_SIZE                  10   "$ENV_FILE"
upsert DATABASE_MAX_OVERFLOW               15   "$ENV_FILE"
upsert DATABASE_POOL_TIMEOUT               8    "$ENV_FILE"
upsert DATABASE_POOL_RECYCLE               1800 "$ENV_FILE"
upsert DATABASE_IDLE_IN_TRANSACTION_TIMEOUT_SECONDS 35   "$ENV_FILE"
upsert DATABASE_STATEMENT_TIMEOUT_SECONDS          0    "$ENV_FILE"
upsert DATABASE_ACTIVE_QUERY_KILL_SECONDS          45   "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_ENABLED                true "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_INTERVAL_SECONDS       10   "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_MIN_IDLE_SECONDS       18   "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_AGGRESSIVE_MIN_IDLE_SECONDS 12 "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_TRIGGER_IDLE_COUNT     10   "$ENV_FILE"
upsert DATABASE_POOL_SELF_HEAL_INTERVAL_SECONDS    15   "$ENV_FILE"
upsert DATABASE_POOL_SELF_HEAL_MAX_FAILURES        1    "$ENV_FILE"
