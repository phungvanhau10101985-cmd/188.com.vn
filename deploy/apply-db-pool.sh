...
upsert DATABASE_POOL_RELIEF_INTERVAL_SECONDS       15   "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_MIN_IDLE_SECONDS       22   "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_AGGRESSIVE_MIN_IDLE_SECONDS 18 "$ENV_FILE"
upsert DATABASE_POOL_RELIEF_TRIGGER_IDLE_COUNT     14   "$ENV_FILE"
